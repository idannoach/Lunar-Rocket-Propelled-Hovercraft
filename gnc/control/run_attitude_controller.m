function [desired_Fz, desired_My] = run_attitude_controller(x_curr, cmd_n, cmd_u, hovercraft_parameters)
...
desired_theta = atan2(cmd_n, cmd_u);
...
% desired_theta) exactly delivers the commanded NWU-Z acceleration.
...
% (Positive desired_Fz = upward body force, consistent with Body-Z pointing up.)
desired_Fz = mass * cmd_u / cos(desired_theta);
