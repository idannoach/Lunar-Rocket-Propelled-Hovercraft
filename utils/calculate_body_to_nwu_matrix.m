function R_b2n = calculate_body_to_nwu_matrix(phi, theta, psi)
% calculate_body_to_nwu_matrix - Computes the transformation matrix from 
%                                the Body frame to the local NWU frame.
%
...
%           from the Body frame to the NWU frame: V_nwu = R_b2n * V_body
...
% Compute the elements of the Body-to-NWU transformation matrix
